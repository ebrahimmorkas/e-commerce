    ...
    <div className="container mx-auto flex py-8">
      ...
      <div className="w-[70%] flex px-4 space-x-4">
        <div className="flex flex-col w-[30%]">
          {/* Main product image */}
          <div className="h-[70%]">
            <img src={herocomponentimage} alt="Main Product Image" className="w-full h-full object-cover" />
          </div>
          {/* Product title */}
        ...
        <div className="w-[40%] space-y-4">
          {/* Product description */}
          <p className="text-gray-700 my-10">This is a detailed description of the product. It explains features, benefits, and more.</p>
          {/* Product price */}
